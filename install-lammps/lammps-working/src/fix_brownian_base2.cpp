...
FixBrownianBase2::FixBrownianBase2(LAMMPS *lmp, int narg, char **arg) : Fix(lmp, narg, arg)
{
  time_integrate = 1;
...
FixBrownianBase2::~FixBrownianBase2()
{
...
void FixBrownianBase2::reset_dt()
{
