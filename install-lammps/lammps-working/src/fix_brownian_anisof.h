...
#ifdef FIX_CLASS
// clang-format off
FixStyle(brownian/anisof,FixBrownianAnisof);
// clang-format on
#else

#ifndef LMP_FIX_BROWNIAN_ANISOF_H
#define LMP_FIX_BROWNIAN_ANISOF_H

#include "fix_brownian_base.h"

namespace LAMMPS_NS {

class FixBrownianAnisof : public FixBrownianBase {
 public:
  FixBrownianAnisof(class LAMMPS *, int, char **);
  virtual ~FixBrownianAnisof(){};
  void init();
