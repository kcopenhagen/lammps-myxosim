...
void Atom::peratom_create()
{
  ...
  add_peratom("af",&af,DOUBLE,0);
  add_peratom("ttr",&ttr,DOUBLE,0);
  add_peratom("nmu",&nmu,DOUBLE,3);
  add_peratom("amu",&amu,DOUBLE,3);
...
.. list-table::
   ...
   * - nmu
     - double
     - 3
     - noise dipole moment of the particles
   * - amu
     - double
     - 3
     - alternate dipole moment of the particles
   * - af
     - double
     - 1
     - active force of particle
   * - omega
     - double
     - 3
...
void *Atom::extract(const char *name)
{
  ...
  if (strcmp(name,"nmu") == 0) return (void *) nmu;
  if (strcmp(name,"amu") == 0) return (void *) amu;
  ...
  if (strcmp(name,"af") == 0) return (void *) af;
  if (strcmp(name,"ttr") == 0) return (void *) ttr;
...
int Atom::extract_datatype(const char *name)
{
  ...
  if (strcmp(name,"nmu") == 0) return LAMMPS_DOUBLE_2D;
  if (strcmp(name,"amu") == 0) return LAMMPS_DOUBLE_2D;
  ...
  if (strcmp(name,"af") == 0) return LAMMPS_DOUBLE;
  if (strcmp(name,"ttr") == 0) return LAMMPS_DOUBLE;
