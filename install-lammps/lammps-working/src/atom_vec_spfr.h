...
#ifdef ATOM_CLASS
// clang-format off
AtomStyle(spfr,AtomVecSPFR);
// clang-format on
#else

#ifndef LMP_ATOM_VEC_SPFR_H
#define LMP_ATOM_VEC_SPFR_H

#include "atom_vec.h"

namespace LAMMPS_NS {

class AtomVecSPFR : public AtomVec {
 public:
  AtomVecSPFR(class LAMMPS *);
  ~AtomVecSPFR();
